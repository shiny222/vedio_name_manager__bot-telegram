...
BUTTON_FA = {
    ...
    "📺 Anime Series": "📺 سریال‌های انیمه",
    "🎬 Anime Movies": "🎬 فیلم‌های انیمه",
    "🌐 Language": "🌐 زبان",
}
...
TEXT_FA = {
    ...
    "Searching AniList movies for:": "در حال جستجوی فیلم در AniList برای:",
    ...
    "Searching AniList for:": "در حال جستجو در AniList برای:",
    ...
    "Final folder format: AniList Title (Year)": "قالب نهایی پوشه: AniList Title (Year)",
    "The selected metadata identity differs from the detected title/year.": "هویت متادیتای انتخاب‌شده با نام یا سال تشخیص‌داده‌شده متفاوت است.",
