...
LABEL org.opencontainers.image.description="Telegram download bot with independent series, movie, IMDb, and AniList tools"
...
COPY anilist_search/requirements.txt /tmp/requirements-anilist-search.txt
...
RUN python -m pip install --upgrade pip \
    && python -m pip install \
        ...
        -r /tmp/requirements-anilist-search.txt \
...
COPY --chown=1000:1000 anilist_search /app/anilist_search

RUN mkdir -p /app/data /app/logs /app/staging /app/fuzzy_search/data /app/anilist_search/data \
    && chown -R 1000:1000 /app/data /app/logs /app/staging /app/fuzzy_search/data /app/anilist_search/data
